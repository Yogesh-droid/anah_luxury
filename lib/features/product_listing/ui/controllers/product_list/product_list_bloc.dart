    ...
    on<ProductListEvent>((event, emit) async {
      ...
      try {
        if(event is GetProductListEvent){
          final DataState<Map<ProductStateType,dynamic>> data =  await productListUsecase.call(RequestParams(url: "${baseUrl}v1/getProducts?${event.query}", apiMethods: ApiMethods.get,header: {
          ...
          if(data.data!=null){
            ...
            if(productList!=null && filterList!=null){
              emit(ProductListFinal(productList: productList!,filtersList: filterList!));
            }
          }else{
