...
class AnahCalendarDatePicker extends StatefulWidget {
  ...
  @override
  State<AnahCalendarDatePicker> createState() => _CalendarDatePickerState();
}

class _CalendarDatePickerState extends State<AnahCalendarDatePicker> {
  ...
  @override
  void didUpdateWidget(AnahCalendarDatePicker oldWidget) {
      ...
      if (day < 1) {
        ...
        if (isSelectedDay) {
          ...
          decoration = const BoxDecoration(
              color: black, borderRadius: BorderRadius.all(Radius.circular(4)));
        } else if (isToday) {
          ...
          decoration = const BoxDecoration(
              color: grey5, borderRadius: BorderRadius.all(Radius.circular(4)));
        }
